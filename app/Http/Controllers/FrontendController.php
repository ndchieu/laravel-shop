...
class FrontendController extends Controller
{
    ...
    public function index()
    {
        ...
        $popular=Product::paginate(6);
        return view('website.frontend.layouts.main', compact('popular'));//compact() tao 1 mang tu bien da dinh nghia
    }
     ...
     */
     ...
     public function addToCart(Request $request, $id){
         $product=Product::find($id); //find() lay ra tu model
        ...
        //  dd($request->session()->get('cart'));
         return redirect()->route('website.index');//duong dan tra ve

     }

     public function deleteCart(Request $request, $item){
