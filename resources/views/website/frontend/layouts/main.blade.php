                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                    <div class="single-new-pro mb-30 text-center">
                        <div class="product-img">
                            <img src="{{asset('images/'.$pro->img)}}" alt="" height="300">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                    <div class="single-popular-items mb-50 text-center">
                        <div class="popular-img">
                            <img src="{{asset('images/'.$pop->img)}}" alt="" height="300px">
                            <div class="img-cap">
                                <form action="{{ route('cart.store') }}" method="POST" enctype="multipart/form-data">
                                    {{-- {{ dd($productCate) }} --}}
                                    @csrf
                                    <input type="hidden" value="{{ $pop->id }}" name="id">
                                    <input type="hidden" value="{{ $pop->product_name }}" name="name">
                                    <input type="hidden" value="{{ $pop->price }}" name="price">
                                    <input type="hidden" value="{{ $pop->img }}"  name="image">
                                    <input type="hidden" value="1" name="quantity">
                                    <button class="p-4 w-100 text-white bg-blue-800 rounded btn btn-primary">Add To Cart</button>
                                </form>
                            </div>
                        ...
                        <h3><a href="{{route('product_details',$pop->id)}}">{{$pop->product_name}}</a></h3>
                            <span>$ {{$pop->price}}</span>
                        </div>
                    </div>
                </div>
